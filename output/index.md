    ...
    "resource" : [
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/ARATQuestionnaireResponse"
        },
        "name" : "ARAT上肢功能評估問卷回覆",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "QuestionnaireResponse/arat-response-example-001"
        },
        "name" : "ARAT問卷回覆範例",
        "description" : "一位右側中風患者進行左側上肢ARAT評估的問卷回覆範例，包含各測試項目分數、完成時間及自動計算分數",
        "exampleCanonical" : "http://example.org/StructureDefinition/ARATQuestionnaireResponse"
      },
      {
        "extension" : [
          {
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/test-time-extension"
        },
        "name" : "測試時間擴展",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/assessment-side-valueset"
        },
        "name" : "評估側別選項",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/SPACQuestionnaire"
        },
        "name" : "評估問卷",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/SPACQuestionnaireResponse"
        },
        "name" : "評估問卷回覆",
